...
export interface TestDefinition { id:TestId; label:string; shortLabel:string; icon:string; description:string; questionCount:number; questions:Question[]; outcomes:Record<string,Outcome> }
