...
const rankData:Record<MissionRank,{xp:number;rep:number;tp:number;ryo:number}>={D:{xp:80,rep:8,tp:2,ryo:60},C:{xp:150,rep:14,tp:3,ryo:120},B:{xp:300,rep:24,tp:5,ryo:240},A:{xp:550,rep:40,tp:8,ryo:450},S:{xp:900,rep:65,tp:12,ryo:800}};
...
const blankProgression=(userId:string,characterId:string):ShinobiProgression=>({character_id:characterId,user_id:userId,xp:0,level:1,village_reputation:0,training_points:0,ryo:0,training_bonuses:{},completed_missions:0,d_missions:0,c_missions:0,b_missions:0,a_missions:0,s_missions:0,current_title:'New Operative',updated_at:nowIso()});
